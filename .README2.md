...
- 활용신청 현황
  ...
  ![](assets/20260610_172345_20260610_114336_image.png)
- 참고문서 확인 - json을 서비스 지원 확인

  ![](assets/20260610_114831_image.png)
- URL 사용할 일반인증키(Encoding) Service에 사용

  ![](assets/20260610_115744_image.png)
- 크롬 브라우저 사용시 - Chrom 웹스토어 > `Seven JSON Viewer` 검색, 설치

  ![](assets/20260610_115945_image.png)
- 서비스URL 구조
...
- 로그를 파일이나 DB에 저장하는 현태로 사용 가능

##### NuGet 패키지에서 설치

##### NLog.config 설정
- 프로젝트 최상위 폴더에서 xml 파일로 NLog.config를생성
- 아래와 같이 작성
